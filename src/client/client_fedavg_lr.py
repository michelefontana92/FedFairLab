...
from wrappers import TorchNNLRWrapper
from functools import partial
from .client_factory import register_client
import torch
import os

@register_client("client_fedavg_lr")
@ray.remote(num_cpus=1)
class ClientFedAvgLR(BaseClient):
    ...
    def __init__(self, **kwargs):
        ...
        print(f"[INFO] Initializing ClientFedAvgLR with id: {self.client_name}, metrics: {self.metrics}, monitor: {self.checkpoint_config['monitor']}, num_epochs: {self.num_epochs}")
